      ...
      products: {
        ...
        nodes: Array<
          Pick<
            ...
            'id' | 'title' | 'handle' | 'vendor' | 'tags' | 'availableForSale'
          > & {
            priceRange: {
...
export type QuickViewProductByHandleQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type QuickViewProductByHandleQuery = {
  product?: StorefrontAPI.Maybe<
    Pick<
      StorefrontAPI.Product,
      'id' | 'title' | 'handle' | 'vendor' | 'description'
...
export type VariantsToProductsQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
}>;

export type VariantsToProductsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
...
export type FooterMenusQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  shopMenuHandle: StorefrontAPI.Scalars['String']['input'];
  helpMenuHandle: StorefrontAPI.Scalars['String']['input'];
  aboutMenuHandle: StorefrontAPI.Scalars['String']['input'];
  legalMenuHandle: StorefrontAPI.Scalars['String']['input'];
}>;

export type FooterMenusQuery = {
    ...
    availableCountries: Array<
      Pick<StorefrontAPI.Country, 'isoCode' | 'name'> & {
        ...
        availableLanguages: Array<
          Pick<StorefrontAPI.Language, 'isoCode' | 'name'>
        >;
      }
    >;
...
export type ShopMetafieldsQuery = {
  shop: {
    social_instagram?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
    social_facebook?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
    social_twitter?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
    social_pinterest?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
    social_tiktok?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
    social_youtube?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
  };
};

export type MenuValidationQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type MenuValidationQuery = {
  menu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<Pick<StorefrontAPI.MenuItem, 'id'>>;
    }
  >;
};

export type MetaobjectValidationQueryVariables = StorefrontAPI.Exact<{
  type: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type MetaobjectValidationQuery = {
  metaobjects: {nodes: Array<Pick<StorefrontAPI.Metaobject, 'id'>>};
};

export type ShopMetafieldsValidationQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type ShopMetafieldsValidationQuery = {
  shop: {
    social_instagram?: StorefrontAPI.Maybe<
      Pick<StorefrontAPI.Metafield, 'value'>
    >;
...
export type FeatureBannerQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type FeatureBannerQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type PressFeaturesQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type PressFeaturesQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type LookbookItemsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LookbookItemsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type SplitHeroQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SplitHeroQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type InstagramPostsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type InstagramPostsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type NewsletterSectionQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type NewsletterSectionQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type BrandValuesQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type BrandValuesQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
...
export type LookbookCollectionsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LookbookCollectionsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        fields: Array<
...
export type LookbookPageItemsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type LookbookPageItemsQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
  ...
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
          Pick<StorefrontAPI.MetaobjectField, 'key' | 'value'> & {
            reference?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Product, 'id'>>;
          }
        >;
      }
    >;
...
export type StoreLocationsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type CheckExistingReviewQueryVariables = StorefrontAPI.Exact<{
  type: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type CheckExistingReviewQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        fields: Array<Pick<StorefrontAPI.MetaobjectField, 'key' | 'value'>>;
...
export type CheckExistingStockAlertQueryVariables = StorefrontAPI.Exact<{
  type: StorefrontAPI.Scalars['String']['input'];
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type CheckExistingStockAlertQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
        fields: Array<Pick<StorefrontAPI.MetaobjectField, 'key' | 'value'>>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment QuickViewProduct on Product {\n    id\n    title\n    handle\n    vendor\n    description\n    options {\n      name\n      values\n    }\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    images(first: 10) {\n      nodes {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n    variants(first: 100) {\n      nodes {\n        ...ProductVariant\n      }\n    }\n  }\n\n  query QuickViewProductByHandle($handle: String!, $country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    product(handle: $handle) {\n      ...QuickViewProduct\n    }\n  }\n  #graphql\n  fragment ProductVariant on ProductVariant {\n    availableForSale\n    compareAtPrice {\n      amount\n      currencyCode\n    }\n    id\n    image {\n      __typename\n      id\n      url\n      altText\n      width\n      height\n    }\n    price {\n      amount\n      currencyCode\n    }\n    product {\n      title\n      handle\n    }\n    selectedOptions {\n      name\n      value\n    }\n    sku\n    title\n    unitPrice {\n      amount\n      currencyCode\n    }\n  }\n\n': {
    return: QuickViewProductByHandleQuery;
    variables: QuickViewProductByHandleQueryVariables;
  };
  ...
  '#graphql\n  query VariantsToProducts($ids: [ID!]!) {\n    nodes(ids: $ids) {\n      ... on ProductVariant {\n        id\n        product {\n          id\n        }\n      }\n    }\n  }\n': {
    return: VariantsToProductsQuery;
    variables: VariantsToProductsQueryVariables;
  };
  ...
  '#graphql\n  query FooterMenus(\n    $country: CountryCode\n    $language: LanguageCode\n    $shopMenuHandle: String!\n    $helpMenuHandle: String!\n    $aboutMenuHandle: String!\n    $legalMenuHandle: String!\n  ) @inContext(language: $language, country: $country) {\n    shopMenu: menu(handle: $shopMenuHandle) {\n      ...Menu\n    }\n    helpMenu: menu(handle: $helpMenuHandle) {\n      ...Menu\n    }\n    aboutMenu: menu(handle: $aboutMenuHandle) {\n      ...Menu\n    }\n    legalMenu: menu(handle: $legalMenuHandle) {\n      ...Menu\n    }\n  }\n  #graphql\n  fragment MenuItem on MenuItem {\n    id\n    resourceId\n    tags\n    title\n    type\n    url\n  }\n  fragment ChildMenuItem on MenuItem {\n    ...MenuItem\n  }\n  fragment ParentMenuItem on MenuItem {\n    ...MenuItem\n    items {\n      ...ChildMenuItem\n    }\n  }\n  fragment Menu on Menu {\n    id\n    items {\n      ...ParentMenuItem\n    }\n  }\n\n': {
    return: FooterMenusQuery;
    variables: FooterMenusQueryVariables;
  };
  '#graphql\n  query Localization(\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(language: $language, country: $country) {\n    localization {\n      country {\n        name\n        isoCode\n      }\n      language {\n        name\n        isoCode\n      },\n      availableCountries {\n        isoCode\n        name\n        currency {\n          isoCode\n          name\n          symbol\n        }\n        availableLanguages {\n          isoCode\n          name\n        }\n      }\n      availableLanguages {\n        isoCode\n        name\n      }\n    }\n  }\n': {
  ...
  '#graphql\n        query MenuValidation($handle: String!) {\n          menu(handle: $handle) {\n            id\n            items {\n              id\n            }\n          }\n        }\n      ': {
    return: MenuValidationQuery;
    variables: MenuValidationQueryVariables;
  };
  '#graphql\n          query MenuValidation($handle: String!) {\n            menu(handle: $handle) {\n              id\n              items {\n                id\n              }\n            }\n          }\n        ': {
    return: MenuValidationQuery;
    variables: MenuValidationQueryVariables;
  ...
  '#graphql\n          query MetaobjectValidation($type: String!, $first: Int!) {\n            metaobjects(type: $type, first: $first) {\n              nodes {\n                id\n              }\n            }\n          }\n        ': {
    return: MetaobjectValidationQuery;
    variables: MetaobjectValidationQueryVariables;
  };
  '#graphql\n        query ShopMetafieldsValidation {\n          shop {\n            social_instagram: metafield(namespace: "social", key: "instagram") { value }\n            social_facebook: metafield(namespace: "social", key: "facebook") { value }\n            social_twitter: metafield(namespace: "social", key: "twitter") { value }\n            social_pinterest: metafield(namespace: "social", key: "pinterest") { value }\n            social_tiktok: metafield(namespace: "social", key: "tiktok") { value }\n            social_youtube: metafield(namespace: "social", key: "youtube") { value }\n          }\n        }\n      ': {
    return: ShopMetafieldsValidationQuery;
    variables: ShopMetafieldsValidationQueryVariables;
  };
  ...
  '#graphql\n  query InstagramPosts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobjects(type: "instagram_post", first: 6) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: InstagramPostsQuery;
    variables: InstagramPostsQueryVariables;
  };
  '#graphql\n  query NewsletterSection($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    metaobjects(type: "newsletter_section", first: 1) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: NewsletterSectionQuery;
    variables: NewsletterSectionQueryVariables;
  };
  ...
  '#graphql\n  query BrandValues($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    metaobjects(type: "brand_value", first: 10) {\n      nodes {\n        id\n        fields {\n          key\n          value\n        }\n      }\n    }\n  }\n': {
    return: BrandValuesQuery;
    variables: BrandValuesQueryVariables;
  };
  ...
  '#graphql\n  query LookbookCollections($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    metaobjects(type: "lookbook_collection", first: 10) {\n      nodes {\n        id\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              __typename\n              image {\n                url\n                altText\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: LookbookCollectionsQuery;
    variables: LookbookCollectionsQueryVariables;
  };
  '#graphql\n  query LookbookPageItems($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    metaobjects(type: "lookbook_item", first: 20) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              __typename\n              image {\n                url\n                altText\n              }\n            }\n            ... on Collection {\n              __typename\n              id\n              handle\n              title\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: LookbookPageItemsQuery;
    variables: LookbookPageItemsQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
  ...
  '#graphql\n  query StoreLocations($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    metaobjects(type: "store_location", first: 20) {\n      nodes {\n        id\n        fields {\n          key\n          value\n          reference {\n            ... on MediaImage {\n              __typename\n              image {\n                url\n                altText\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: StoreLocationsQuery;
    variables: StoreLocationsQueryVariables;
  };
  ...
  '#graphql\n        query CheckExistingReview($type: String!, $first: Int!) {\n          metaobjects(type: $type, first: $first) {\n            nodes {\n              id\n              fields {\n                key\n                value\n              }\n            }\n          }\n        }\n      ': {
    return: CheckExistingReviewQuery;
    variables: CheckExistingReviewQueryVariables;
  };
  '#graphql\n        query CheckExistingStockAlert($type: String!, $first: Int!) {\n          metaobjects(type: $type, first: $first) {\n            nodes {\n              id\n              fields {\n                key\n                value\n              }\n            }\n          }\n        }\n      ': {
    return: CheckExistingStockAlertQuery;
    variables: CheckExistingStockAlertQueryVariables;
  };
}
