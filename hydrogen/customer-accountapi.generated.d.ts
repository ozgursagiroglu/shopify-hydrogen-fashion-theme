...
export type CustomerPurchasedProductsQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type CustomerPurchasedProductsQuery = {
  customer: {
    orders: {
      nodes: Array<
        Pick<CustomerAccountAPI.Order, 'id' | 'fulfillmentStatus'> & {
          lineItems: {
            nodes: Array<Pick<CustomerAccountAPI.LineItem, 'variantId'>>;
          };
        }
      >;
    };
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerPurchasedProducts($language: LanguageCode) @inContext(language: $language) {\n    customer {\n      orders(\n        first: 250,\n        query: "financial_status:paid OR financial_status:partially_paid"\n      ) {\n        nodes {\n          id\n          fulfillmentStatus\n          lineItems(first: 250) {\n            nodes {\n              variantId\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CustomerPurchasedProductsQuery;
    variables: CustomerPurchasedProductsQueryVariables;
  };
}
